...
public class BinanceAPISource implements SourceFunction<Double> {
    ...
    public void run(SourceContext<Double> ctx) throws Exception {
        ...
        while (isRunning) {
            ...
            double btcUsdRate = getRealTimeDataFromBinance();
    ...
    public double getRealTimeDataFromBinance() {
    ...
    public class MainApplication {
        public void main(String[] args) throws Exception {
            ...
            env.addSource(new BinanceAPISource())
